        ...
        <button class="backgroundList btn colorPrimary my-2 p-3 col-md-12">
            <div class="p-3">
                ...
                <div class="row col-md-12">
                    <div class="col-md-5">
                        <p class="">Conhecimento da instalação do novo sistema</p>
                        <p class="">Analise do necessário para a implantação</p>
                        <p class="">Controle das etapas de instalação</p>
                        <p class="">Implementação de um novo sistema na empresa</p>
                    </div>
                    <div class="col-md-1">
                        <p class="bg-info">I</p>
                        <p class="bg-warning">A</p>
                        <p class="visually-hidden-focusable">não</p>
                        <p class="bg-danger">R</p>                            
                    </div>
                    <div class="col-md-2">
                        <p class="">R</p>
                        <p class="">C</p>
